...
public class MonthToolbarInstrumentedTest {
    ...
    public final ViewScenarioRule viewRule =
            new ViewScenarioRule(MonthToolbarView.class);

    @Test
    public void buttons_are_hidden_correctly() {
        viewRule.getScenario().onActivity(activity -> ((MonthToolbarView) activity.getHostedView())
                .setViewModel(new ViewModelProvider(activity)
